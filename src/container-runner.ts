...
async function buildContainerArgs(
  ...
  // Egress lockdown when enabled (upstream feature; off by default) — throws
  // if it can't be established, aborting the spawn rather than running with
  // open egress. Otherwise the host gateway, which the credential proxy needs.
